class Ninja {
    ...
    loadBoyAnimations() {
        ...
        this.animations[0][1] = new Animator(this.spritesheetright, 11, 521, 250 - 11, 974 - 521, 9, .05, 3, false, true);


        // running right
        this.animations[1][0] = new Animator(this.spritesheetright, 16, 1494, 385 - 16, 1954 - 1494, 10, .05, 5, false, true);
        this.animations[1][1] = new Animator(this.spritesheetright, 16, 1494, 385 - 16, 1954 - 1494, 10, .05, 5, false, true);

        // jumping right
        this.animations[2][0] = new Animator(this.spritesheetright, 30, 1000, 395 - 45, 1476 - 1000, 10, .05, 21, false, true);
        this.animations[2][1] = new Animator(this.spritesheetright, 30, 1000, 395 - 45, 1476 - 1000, 10, .05, 21, false, true);

        // attacking right
        this.animations[3][0] = new Animator(this.spritesheetright, 25, 30, 595 - 60, 484 - 30, 10, .05, 11, false, true);
        this.animations[3][1] = new Animator(this.spritesheetright, 25, 30, 595 - 60, 484 - 30, 10, .05, 11, false, true);

        // Death right
        this.animations[4][0] = new Animator(this.spritesheetright, 18, 1985, 505 - 18, 2470 - 1985, 10, .05, 5, false, true);
        this.animations[4][1] = new Animator(this.spritesheetright, 18, 1985, 505 - 18, 2470 - 1985, 10, .05, 5, false, true);
    }
    ...
    draw(ctx) {
        ...
        this.animations[4][0].drawFrame(this.game.clockTick, ctx, 400, this.y, .25);
    }
}